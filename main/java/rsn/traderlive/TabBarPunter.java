...
public class TabBarPunter extends Fragment {
    ...
    private DatabaseReference punterInfo;

    private static final String FIREBASEDB_PUNTERINFO = "punterInfo";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.tab_bar_punter, container, false);
        ...
        punterInfo = mRootReference.child(FIREBASEDB_PUNTERINFO);
    ...
    public void onStart() {
        ...
        punterInfo.addValueEventListener(new ValueEventListener() {

            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ((TextView)view.findViewById(R.id.punterInfo)).setText(dataSnapshot.getValue(String.class));
            }
            @Override
