 ...
 */
public class TabBarMult extends Fragment {
    ...
    private DatabaseReference multInfo;

    private static final String FIREBASEDB_MULTINFO = "multiplaInfo";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.tab_bar_mult, container, false);
        ...
        multInfo = mRootReference.child(FIREBASEDB_MULTINFO);
    ...
    public void onStart() {
        ...
        multInfo.addValueEventListener(new ValueEventListener() {

            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ((TextView)view.findViewById(R.id.multiplaOdd)).setText(dataSnapshot.getValue(String.class));
            }
            @Override
